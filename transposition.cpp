...
/*
  ...
  Module for the transposition table.

*/


namespace transposition {
constexpr u64_t index_mask = (1ULL << TRANSPOSITION_TABLE_SIZE_LOG2) - 1;
...
static std::array<entry_t, 1ULL << TRANSPOSITION_TABLE_SIZE_LOG2> table;
...
// get the table size
u64_t table_size() {
  return sizeof(entry_t) * (1ULL << TRANSPOSITION_TABLE_SIZE_LOG2);
};
};
