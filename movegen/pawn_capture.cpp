...
void generate_pawn_capture_moves(T& moves, Board& board, detail_t& detail) {
  ...
  bitboard_t bishop_checking_squares_no_pawns = attack<bishop>(detail.opponent_king_square, board.bitboards[piece::none] & ~board.bitboards[pawn]);
  ...
  while (non_discoverable_promoting_free_pawns) {
    ...
    bitboard_t bishop_checking_squares = attack<bishop>(detail.opponent_king_square, board.bitboards[piece::none] & ~bitboard(from));
    bitboard_t queen_checking_squares = attack<queen>(detail.opponent_king_square, board.bitboards[piece::none] & ~bitboard(from));
